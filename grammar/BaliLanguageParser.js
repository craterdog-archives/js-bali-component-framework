...
var ruleNames =  [ "document", "component", "item", "structure", "parameters", 
                   ...
                   "handleClause", "recipient", "subcomponent", "variable", 
                   "indices", "expression", "funxtion", "message", "element", 
                   "binary", "duration", "imaginary", "moment", "number", 
                   "percent", "probability", "real", "reference", "symbol", 
                   "tag", "template", "text", "version" ];
...
BaliLanguageParser.RULE_subcomponent = 33;
BaliLanguageParser.RULE_variable = 34;
BaliLanguageParser.RULE_indices = 35;
BaliLanguageParser.RULE_expression = 36;
BaliLanguageParser.RULE_funxtion = 37;
BaliLanguageParser.RULE_message = 38;
BaliLanguageParser.RULE_element = 39;
BaliLanguageParser.RULE_binary = 40;
BaliLanguageParser.RULE_duration = 41;
BaliLanguageParser.RULE_imaginary = 42;
BaliLanguageParser.RULE_moment = 43;
BaliLanguageParser.RULE_number = 44;
BaliLanguageParser.RULE_percent = 45;
BaliLanguageParser.RULE_probability = 46;
BaliLanguageParser.RULE_real = 47;
BaliLanguageParser.RULE_reference = 48;
BaliLanguageParser.RULE_symbol = 49;
BaliLanguageParser.RULE_tag = 50;
BaliLanguageParser.RULE_template = 51;
BaliLanguageParser.RULE_text = 52;
BaliLanguageParser.RULE_version = 53;
...
BaliLanguageParser.prototype.subcomponent = function() {
    ...
    this.enterRule(localctx, 66, BaliLanguageParser.RULE_subcomponent);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 371;
        this.variable();
...
BaliLanguageParser.prototype.variable = function() {
    ...
    this.enterRule(localctx, 68, BaliLanguageParser.RULE_variable);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 374;
...
BaliLanguageParser.prototype.indices = function() {
    ...
    this.enterRule(localctx, 70, BaliLanguageParser.RULE_indices);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 376;
        this.match(BaliLanguageParser.T__0);
...
BaliLanguageParser.prototype.element = function() {
    ...
    this.enterRule(localctx, 78, BaliLanguageParser.RULE_element);
    try {
        this.state = 447;
        this._errHandler.sync(this);
...
BaliLanguageParser.prototype.binary = function() {
    ...
    this.enterRule(localctx, 80, BaliLanguageParser.RULE_binary);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 449;
...
BaliLanguageParser.prototype.imaginary = function() {
    ...
    this.enterRule(localctx, 84, BaliLanguageParser.RULE_imaginary);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 455;
        this._errHandler.sync(this);
...
BaliLanguageParser.prototype.moment = function() {
    ...
    this.enterRule(localctx, 86, BaliLanguageParser.RULE_moment);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 459;
...
BaliLanguageParser.prototype.number = function() {
    ...
    this.enterRule(localctx, 88, BaliLanguageParser.RULE_number);
    var _la = 0; // Token type
    try {
        this.state = 471;
        this._errHandler.sync(this);
...
BaliLanguageParser.prototype.percent = function() {
    ...
    this.enterRule(localctx, 90, BaliLanguageParser.RULE_percent);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 473;
        this.real();
...
BaliLanguageParser.prototype.real = function() {
    ...
    this.enterRule(localctx, 94, BaliLanguageParser.RULE_real);
    var _la = 0; // Token type
    try {
        this.state = 486;
        this._errHandler.sync(this);
...
BaliLanguageParser.prototype.reference = function() {
    ...
    this.enterRule(localctx, 96, BaliLanguageParser.RULE_reference);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 488;
...
BaliLanguageParser.prototype.tag = function() {
    ...
    this.enterRule(localctx, 100, BaliLanguageParser.RULE_tag);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 492;
...
BaliLanguageParser.prototype.template = function() {
    ...
    this.enterRule(localctx, 102, BaliLanguageParser.RULE_template);
    try {
        this.state = 496;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
BaliLanguageParser.prototype.text = function() {
    ...
    this.enterRule(localctx, 104, BaliLanguageParser.RULE_text);
    try {
        this.state = 500;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
BaliLanguageParser.prototype.version = function() {
    ...
    this.enterRule(localctx, 106, BaliLanguageParser.RULE_version);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 502;

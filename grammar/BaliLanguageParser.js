...
BaliLanguageParser.RULE_block = 34;
BaliLanguageParser.RULE_variable = 35;
BaliLanguageParser.RULE_indices = 36;
BaliLanguageParser.RULE_expression = 37;
...
BaliLanguageParser.prototype.block = function() {
    ...
    this.enterRule(localctx, 68, BaliLanguageParser.RULE_block);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 376;
        this.match(BaliLanguageParser.T__7);
...
BaliLanguageParser.prototype.variable = function() {
    ...
    this.enterRule(localctx, 70, BaliLanguageParser.RULE_variable);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 380;
...
BaliLanguageParser.prototype.indices = function() {
    ...
    this.enterRule(localctx, 72, BaliLanguageParser.RULE_indices);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 382;
        this.match(BaliLanguageParser.T__0);
...
BaliLanguageParser.prototype.expression = function(_p) {
    ...
    var _startState = 74;
    this.enterRecursionRule(localctx, 74, BaliLanguageParser.RULE_expression, _p);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 406;

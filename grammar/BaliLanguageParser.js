...
var ruleNames =  [ "document", "component", "structure", "parameters", "composite", 
                   ...
                   "returnClause", "throwClause", "handleClause", "finishClause", 
                   "label", "variable", "indices", "expression", "name", 
...
BaliLanguageParser.RULE_finishClause = 30;
...
BaliLanguageParser.RULE_name = 35;
BaliLanguageParser.RULE_element = 36;
BaliLanguageParser.RULE_binary = 37;
BaliLanguageParser.RULE_duration = 38;
BaliLanguageParser.RULE_imaginary = 39;
BaliLanguageParser.RULE_moment = 40;
BaliLanguageParser.RULE_number = 41;
BaliLanguageParser.RULE_percent = 42;
BaliLanguageParser.RULE_probability = 43;
BaliLanguageParser.RULE_real = 44;
BaliLanguageParser.RULE_reference = 45;
BaliLanguageParser.RULE_symbol = 46;
BaliLanguageParser.RULE_tag = 47;
BaliLanguageParser.RULE_template = 48;
BaliLanguageParser.RULE_text = 49;
BaliLanguageParser.RULE_version = 50;
...
BaliLanguageParser.prototype.procedure = function() {
    ...
    try {
        ...
        case 2:
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << BaliLanguageParser.T__0) | (1 << BaliLanguageParser.T__2) | (1 << BaliLanguageParser.T__7) | (1 << BaliLanguageParser.T__11) | (1 << BaliLanguageParser.T__13) | (1 << BaliLanguageParser.T__15) | (1 << BaliLanguageParser.T__16) | (1 << BaliLanguageParser.T__17) | (1 << BaliLanguageParser.T__18) | (1 << BaliLanguageParser.T__20) | (1 << BaliLanguageParser.T__22) | (1 << BaliLanguageParser.T__25) | (1 << BaliLanguageParser.T__27) | (1 << BaliLanguageParser.T__28))) !== 0) || ((((_la - 32)) & ~0x1f) == 0 && ((1 << (_la - 32)) & ((1 << (BaliLanguageParser.T__31 - 32)) | (1 << (BaliLanguageParser.T__32 - 32)) | (1 << (BaliLanguageParser.T__33 - 32)) | (1 << (BaliLanguageParser.T__34 - 32)) | (1 << (BaliLanguageParser.T__38 - 32)) | (1 << (BaliLanguageParser.T__42 - 32)) | (1 << (BaliLanguageParser.T__43 - 32)) | (1 << (BaliLanguageParser.T__44 - 32)) | (1 << (BaliLanguageParser.T__47 - 32)) | (1 << (BaliLanguageParser.T__53 - 32)) | (1 << (BaliLanguageParser.T__59 - 32)) | (1 << (BaliLanguageParser.T__60 - 32)) | (1 << (BaliLanguageParser.T__61 - 32)))) !== 0) || ((((_la - 65)) & ~0x1f) == 0 && ((1 << (_la - 65)) & ((1 << (BaliLanguageParser.T__64 - 65)) | (1 << (BaliLanguageParser.T__65 - 65)) | (1 << (BaliLanguageParser.T__66 - 65)) | (1 << (BaliLanguageParser.T__67 - 65)) | (1 << (BaliLanguageParser.TAG - 65)) | (1 << (BaliLanguageParser.SYMBOL - 65)) | (1 << (BaliLanguageParser.FRACTION - 65)) | (1 << (BaliLanguageParser.CONSTANT - 65)) | (1 << (BaliLanguageParser.FLOAT - 65)) | (1 << (BaliLanguageParser.MOMENT - 65)) | (1 << (BaliLanguageParser.DURATION - 65)) | (1 << (BaliLanguageParser.RESOURCE - 65)) | (1 << (BaliLanguageParser.VERSION - 65)) | (1 << (BaliLanguageParser.BINARY - 65)) | (1 << (BaliLanguageParser.TEXT_BLOCK - 65)) | (1 << (BaliLanguageParser.TEXT - 65)) | (1 << (BaliLanguageParser.IDENTIFIER - 65)))) !== 0)) {
                this.state = 216;
                this.statement();
                this.state = 217;
                this.match(BaliLanguageParser.NEWLINE);
...
BaliLanguageParser.prototype.statement = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if(_la===BaliLanguageParser.T__37) {
            this.state = 251;
            this.finishClause();
        }
...
BaliLanguageParser.prototype.finishClause = function() {
    ...
    this.enterRule(localctx, 60, BaliLanguageParser.RULE_finishClause);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 382;
...
MessageExpressionContext.prototype.name = function() {
...
FunctionExpressionContext.prototype.name = function() {
    return this.getTypedRuleContext(NameContext,0);
};
...
BaliLanguageParser.prototype.name = function() {
    ...
    this.enterRule(localctx, 70, BaliLanguageParser.RULE_name);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 445;
        this.match(BaliLanguageParser.IDENTIFIER);
...
BaliLanguageParser.prototype.element = function() {
    ...
    this.enterRule(localctx, 72, BaliLanguageParser.RULE_element);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 459;
        this._errHandler.sync(this);
...
BaliLanguageParser.prototype.binary = function() {
    ...
    this.enterRule(localctx, 74, BaliLanguageParser.RULE_binary);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 464;
...
BaliLanguageParser.prototype.duration = function() {
    ...
    this.enterRule(localctx, 76, BaliLanguageParser.RULE_duration);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 466;
...
BaliLanguageParser.prototype.imaginary = function() {
    ...
    this.enterRule(localctx, 78, BaliLanguageParser.RULE_imaginary);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 470;
        this._errHandler.sync(this);
...
BaliLanguageParser.prototype.number = function() {
    ...
    this.enterRule(localctx, 82, BaliLanguageParser.RULE_number);
    var _la = 0; // Token type
    try {
        this.state = 486;
        this._errHandler.sync(this);
...
BaliLanguageParser.prototype.percent = function() {
    ...
    this.enterRule(localctx, 84, BaliLanguageParser.RULE_percent);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 488;
        this.real();
...
BaliLanguageParser.prototype.probability = function() {
    ...
    this.enterRule(localctx, 86, BaliLanguageParser.RULE_probability);
    try {
        this.state = 494;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
BaliLanguageParser.prototype.real = function() {
    ...
    this.enterRule(localctx, 88, BaliLanguageParser.RULE_real);
    var _la = 0; // Token type
    try {
        this.state = 501;
        this._errHandler.sync(this);
...
BaliLanguageParser.prototype.symbol = function() {
    ...
    this.enterRule(localctx, 92, BaliLanguageParser.RULE_symbol);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 505;
...
BaliLanguageParser.prototype.tag = function() {
    ...
    this.enterRule(localctx, 94, BaliLanguageParser.RULE_tag);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 507;
...
BaliLanguageParser.prototype.template = function() {
    ...
    this.enterRule(localctx, 96, BaliLanguageParser.RULE_template);
    try {
        this.state = 511;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
BaliLanguageParser.prototype.version = function() {
    ...
    this.enterRule(localctx, 100, BaliLanguageParser.RULE_version);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 517;

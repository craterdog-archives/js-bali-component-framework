...
describe('Bali Component Framework™', function() {
    ...
    describe('Test arithmetic operations', function() {
        ...
        it('should test division', function() {
            expect(precision.quotient(1, 3)).to.equal(0.333333333333333);
    ...
    describe('Test power operations', function() {
        ...
        it('should test logarithms', function() {
            ...
            expect(precision.logarithm(precision.E, 4.11e+32)).to.equal(75.09614600432);
            expect(precision.logarithm(10, 4.11e+32)).to.equal(32.61384182188);
    ...
    describe('Test trigonometric operations', function() {
        ...
        it('should test sine', function() {
            ...
            expect(precision.sine(precision.PI / 4)).to.equal(0.707106781186547);
            expect(precision.sine(precision.PI / 2)).to.equal(1);
            expect(precision.sine(precision.PI * 3 / 5)).to.equal(0.951056516295154);
            expect(precision.sine(precision.PI)).to.equal(0);
            expect(precision.sine(precision.PI * 5 / 3)).to.equal(-0.866025403784439);
        ...
        it('should test cosine', function() {
            ...
            expect(precision.cosine(precision.PI / 4)).to.equal(0.707106781186548);
            expect(precision.cosine(precision.PI / 2)).to.equal(0);
            expect(precision.cosine(precision.PI * 3 / 5)).to.equal(-0.30901699437495);
        ...
        it('should test tangent', function() {
            ...
            expect(precision.tangent(precision.PI * 3 / 5)).to.equal(-3.0776835371753);
            expect(precision.tangent(precision.PI)).to.equal(0);
            expect(precision.tangent(precision.PI * 5 / 3)).to.equal(-1.7320508075689);
    ...
    describe('Test inverse trigonometric operations', function() {
        ...
        it('should test arcsine', function() {
            ...
            expect(precision.arcsine(1)).to.equal(1.5707963267949);
            expect(precision.arcsine(-0)).to.equal(0);
            expect(precision.arcsine(-0.54321)).to.equal(-0.57426);
            expect(precision.arcsine(-1)).to.equal(-1.5707963267949);
        });
        ...
        it('should test arccosine', function() {
            expect(precision.arccosine(0)).to.equal(1.5707963267949);
            ...
            expect(precision.arccosine(-1)).to.equal(3.14159265358979);
        });

        it('should test arctangent', function() {
            expect(precision.arctangent(0, 1)).to.equal(0);
            expect(precision.arctangent(-0, 1)).to.equal(0);
            expect(precision.arctangent(1, 1)).to.equal(0.785398163397448);
            expect(precision.arctangent(1, 0)).to.equal(1.5707963267949);
            expect(precision.arctangent(1, -0)).to.equal(1.5707963267949);
            expect(precision.arctangent(1, -1)).to.equal(2.3561944901923);
            expect(precision.arctangent(0, -1)).to.equal(3.14159265358979);
            expect(precision.arctangent(-0, -1)).to.equal(3.14159265358979);
            expect(precision.arctangent(-1, -1)).to.equal(-2.3561944901923);
            expect(precision.arctangent(-1, 0)).to.equal(-1.5707963267949);
            expect(precision.arctangent(-1, -0)).to.equal(-1.5707963267949);

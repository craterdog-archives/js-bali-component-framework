...
describe('Bali Component Framework™', function() {
    ...
    describe('Test power operations', function() {
        ...
        it('should test exponentiation', function() {
            expect(utilities.precision.exponential(utilities.precision.E, 1.2345)).to.equal(3.4367);
            expect(utilities.precision.exponential(utilities.precision.E, 12.345)).to.equal(2.298e+5);
            expect(utilities.precision.exponential(utilities.precision.E, 123.45)).to.equal(Infinity);
            expect(utilities.precision.exponential(10, 12.34)).to.equal(2190000000000);
            expect(utilities.precision.exponential(0, 0).toString()).to.equal(NaN.toString());
            expect(utilities.precision.exponential(0, -0).toString()).to.equal(NaN.toString());
            expect(utilities.precision.exponential(0, 1)).to.equal(0);
            expect(utilities.precision.exponential(0, -1)).to.equal(Infinity);
            expect(utilities.precision.exponential(0, Infinity)).to.equal(0);
            expect(utilities.precision.exponential(0, -Infinity)).to.equal(0);
            expect(utilities.precision.exponential(-0, 0).toString()).to.equal(NaN.toString());
            expect(utilities.precision.exponential(-0, -0).toString()).to.equal(NaN.toString());
            expect(utilities.precision.exponential(-0, 1)).to.equal(0);
            ...
            expect(utilities.precision.exponential(-0, Infinity)).to.equal(0);
            expect(utilities.precision.exponential(-0, -Infinity)).to.equal(0);
            expect(utilities.precision.exponential(1, 0)).to.equal(1);
            expect(utilities.precision.exponential(1, -0)).to.equal(1);
            expect(utilities.precision.exponential(1, 1)).to.equal(1);
            expect(utilities.precision.exponential(1, -1)).to.equal(1);
            expect(utilities.precision.exponential(1, Infinity).toString()).to.equal(NaN.toString());
            expect(utilities.precision.exponential(1, -Infinity).toString()).to.equal(NaN.toString());
            expect(utilities.precision.exponential(-1, 0)).to.equal(1);
            expect(utilities.precision.exponential(-1, -0)).to.equal(1);
            expect(utilities.precision.exponential(-1, 1)).to.equal(-1);
            ...
            expect(utilities.precision.exponential(-1, Infinity).toString()).to.equal(NaN.toString());
            expect(utilities.precision.exponential(-1, -Infinity).toString()).to.equal(NaN.toString());
            expect(utilities.precision.exponential(Infinity, 0).toString()).to.equal(NaN.toString());
            expect(utilities.precision.exponential(Infinity, -0).toString()).to.equal(NaN.toString());
            expect(utilities.precision.exponential(Infinity, 1)).to.equal(Infinity);
            expect(utilities.precision.exponential(Infinity, -1)).to.equal(0);
            expect(utilities.precision.exponential(Infinity, Infinity)).to.equal(Infinity);
            expect(utilities.precision.exponential(Infinity, -Infinity)).to.equal(Infinity);
            expect(utilities.precision.exponential(-Infinity, 0).toString()).to.equal(NaN.toString());
            expect(utilities.precision.exponential(-Infinity, -0).toString()).to.equal(NaN.toString());
            expect(utilities.precision.exponential(-Infinity, 1)).to.equal(Infinity);
        ...
        it('should test logarithms', function() {
            expect(utilities.precision.logarithm(utilities.precision.E, 3.4367)).to.equal(1.2345);
            expect(utilities.precision.logarithm(utilities.precision.E, 229800.1)).to.equal(12.345);
            expect(utilities.precision.logarithm(utilities.precision.E, 4.11e+32)).to.equal(75.096146004318);
            expect(utilities.precision.logarithm(10, 4.11e+32)).to.equal(32.613841821876);
            expect(utilities.precision.logarithm(0, 0).toString()).to.equal(NaN.toString());
            expect(utilities.precision.logarithm(0, -0).toString()).to.equal(NaN.toString());
            expect(utilities.precision.logarithm(0, 1)).to.equal(0);
            expect(utilities.precision.logarithm(0, -1).toString()).to.equal(NaN.toString());
            expect(utilities.precision.logarithm(0, Infinity).toString()).to.equal(NaN.toString());
            expect(utilities.precision.logarithm(0, -Infinity).toString()).to.equal(NaN.toString());
            expect(utilities.precision.logarithm(-0, 0).toString()).to.equal(NaN.toString());
            expect(utilities.precision.logarithm(-0, -0).toString()).to.equal(NaN.toString());
            expect(utilities.precision.logarithm(-0, 1)).to.equal(0);
            ...
            expect(utilities.precision.logarithm(-0, Infinity).toString()).to.equal(NaN.toString());
            expect(utilities.precision.logarithm(-0, -Infinity).toString()).to.equal(NaN.toString());
            expect(utilities.precision.logarithm(1, 0)).to.equal(Infinity);
            expect(utilities.precision.logarithm(1, -0)).to.equal(Infinity);
            expect(utilities.precision.logarithm(1, 1).toString()).to.equal(NaN.toString());
            expect(utilities.precision.logarithm(1, -1).toString()).to.equal(NaN.toString());
            expect(utilities.precision.logarithm(1, Infinity)).to.equal(Infinity);
            expect(utilities.precision.logarithm(1, -Infinity)).to.equal(Infinity);
            expect(utilities.precision.logarithm(-1, 0).toString()).to.equal(NaN.toString());
            expect(utilities.precision.logarithm(-1, -0).toString()).to.equal(NaN.toString());
            expect(utilities.precision.logarithm(-1, 1).toString()).to.equal(NaN.toString());
            expect(utilities.precision.logarithm(-1, -1).toString()).to.equal(NaN.toString());
            expect(utilities.precision.logarithm(-1, Infinity).toString()).to.equal(NaN.toString());
            expect(utilities.precision.logarithm(-1, -Infinity).toString()).to.equal(NaN.toString());
            expect(utilities.precision.logarithm(Infinity, 0).toString()).to.equal(NaN.toString());
            expect(utilities.precision.logarithm(Infinity, -0).toString()).to.equal(NaN.toString());
            expect(utilities.precision.logarithm(Infinity, 1)).to.equal(0);
            expect(utilities.precision.logarithm(Infinity, -1).toString()).to.equal(NaN.toString());
            expect(utilities.precision.logarithm(Infinity, Infinity).toString()).to.equal(NaN.toString());
            expect(utilities.precision.logarithm(Infinity, -Infinity).toString()).to.equal(NaN.toString());
            expect(utilities.precision.logarithm(-Infinity, 0).toString()).to.equal(NaN.toString());
            expect(utilities.precision.logarithm(-Infinity, -0).toString()).to.equal(NaN.toString());
            expect(utilities.precision.logarithm(-Infinity, 1)).to.equal(0);

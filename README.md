 ...
 * [**`bali.Iterator`**](https://https://github.com/craterdog-bali/js-bali-component-framework/blob/master/src/components/Iterator.js) - An iterator component moves over a collection allowing a program to look at the items in the collection one at a time in order, either moving forwards through the collection or backwards through the collection.
 * [**`bali.Sorter`**](https://https://github.com/craterdog-bali/js-bali-component-framework/blob/master/src/components/Sorter.js) - A sorter component implements a specific sorting algorithm and can be used to sort any sortable collection like a [`bali.List`](https://github.com/craterdog-bali/js-bali-component-framework/blob/master/src/composites/List.js) or [`bali.Catalog`](https://github.com/craterdog-bali/js-bali-component-framework/blob/master/src/composites/Catalog.js). The default sorting algorithm is a merge sort.
 * [**`bali.Comparator`**](https://https://github.com/craterdog-bali/js-bali-component-framework/blob/master/src/components/Comparator.js) - A comparator component can be used to compare two other components (usually items in a collection) for their ordering. The default comparator determines the "natural" ordering of the two components.

...
exports.base2Decode = function(base2) {
    ...
    if (length % 8 !== 0) {
        throw "The base 2 string must have a number of characters that is divisible by 8: " + base2;
    }
    ...
    while (index < length - 7) {
        ...
        for (var b = 7; b >= 0; b--) {
            ...
            if (bit < 0) {
                throw "Attempted to decode a string that is not base 2: " + base2;
            }
            byte |= (bit << b);
        }
...
exports.base16Decode = function(base16) {
    ...
    if (length % 2 !== 0) {
        throw "The base 16 string must have an even number of characters: " + base16;
    }
    ...
    while (index < length - 1) {
        ...
        if (highOrderNybble < 0) {
            throw "Attempted to decode a string that is not base 16: " + base16;
        }
...
exports.base32Decode = function(base32) {
    ...
    while (index < length - 1) {
        ...
        if (chunk < 0) {
            throw "Attempted to decode a string that is not base 32: " + base32;
        }

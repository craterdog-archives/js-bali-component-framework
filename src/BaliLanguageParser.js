// Generated from src/BaliLanguage.g4 by ANTLR 4.5.1
// jshint ignore: start
...
var literalNames = [ 'null', "'['", "']'", "'..'", "','", "':'", "'('", 
                     ...
                     "'with'", "'finish'", "':='", "'?='", "'+='", "'-='", 
                     "'*='", "'/='", "'//='", "'^='", "'a='", "'s='", "'o='", 
                     "'x='", "'queue'", "'for'", "'publish'", "'wait'", 
                     "'continue'", "'to'", "'break'", "'from'", "'return'", 
                     "'throw'", "'if'", "'then'", "'else'", "'select'", 
                     "'do'", "'while'", "'each'", "'in'", "'@'", "'.'", 
                     "'!'", "'^'", "'-'", "'/'", "'*'", "'//'", "'+'", "'|'", 
                     "'<'", "'='", "'>'", "'is'", "'matches'", "'not'", 
                     "'and'", "'sans'", "'xor'", "'or'", "'?'", "'none'", 
                     "'any'", "'true'", "'false'", "'%'", "'e'", "'pi'", 
                     "'phi'", "'i'", "'undefined'", "'infinity'", "'e^'" ];
...
var ruleNames =  [ "document", "literal", "structure", "composite", "range", 
                   "collection", "table", "association", "key", "parameters", 
                   "script", "block", "statements", "statement", "exceptionClause", 
                   "exception", "finalClause", "mainClause", "evaluateExpression", 
                   "assignee", "target", "component", "queueMessage", "recipient", 
                   "publishEvent", "waitForEvent", "event", "continueTo", 
...
BaliLanguageParser.RULE_parameters = 9;
BaliLanguageParser.RULE_script = 10;
...
BaliLanguageParser.RULE_exception = 15;
...
BaliLanguageParser.RULE_target = 20;
BaliLanguageParser.RULE_component = 21;
BaliLanguageParser.RULE_queueMessage = 22;
BaliLanguageParser.RULE_recipient = 23;
BaliLanguageParser.RULE_publishEvent = 24;
BaliLanguageParser.RULE_waitForEvent = 25;
BaliLanguageParser.RULE_event = 26;
BaliLanguageParser.RULE_continueTo = 27;
BaliLanguageParser.RULE_breakFrom = 28;
BaliLanguageParser.RULE_label = 29;
BaliLanguageParser.RULE_returnResult = 30;
BaliLanguageParser.RULE_result = 31;
BaliLanguageParser.RULE_throwException = 32;
...
BaliLanguageParser.RULE_name = 60;
...
CompositeContext.prototype.collection = function() {
...
function InlineCollectionContext(parser, ctx) {
	CollectionContext.call(this, parser);
    CollectionContext.prototype.copyFrom.call(this, ctx);
    return this;
}

InlineCollectionContext.prototype = Object.create(CollectionContext.prototype);
InlineCollectionContext.prototype.constructor = InlineCollectionContext;

BaliLanguageParser.InlineCollectionContext = InlineCollectionContext;

InlineCollectionContext.prototype.expression = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
...
InlineCollectionContext.prototype.enterRule = function(listener) {
    if(listener instanceof BaliLanguageListener ) {
        listener.enterInlineCollection(this);
	}
};

InlineCollectionContext.prototype.exitRule = function(listener) {
    if(listener instanceof BaliLanguageListener ) {
        listener.exitInlineCollection(this);
	}
};

InlineCollectionContext.prototype.accept = function(visitor) {
    if ( visitor instanceof BaliLanguageVisitor ) {
        return visitor.visitInlineCollection(this);
    } else {
        return visitor.visitChildren(this);
    }
};
...
function EmptyCollectionContext(parser, ctx) {
	CollectionContext.call(this, parser);
    CollectionContext.prototype.copyFrom.call(this, ctx);
    return this;
}

EmptyCollectionContext.prototype = Object.create(CollectionContext.prototype);
EmptyCollectionContext.prototype.constructor = EmptyCollectionContext;

BaliLanguageParser.EmptyCollectionContext = EmptyCollectionContext;

EmptyCollectionContext.prototype.enterRule = function(listener) {
    if(listener instanceof BaliLanguageListener ) {
        listener.enterEmptyCollection(this);
	}
};

EmptyCollectionContext.prototype.exitRule = function(listener) {
    if(listener instanceof BaliLanguageListener ) {
        listener.exitEmptyCollection(this);
	}
};

EmptyCollectionContext.prototype.accept = function(visitor) {
    if ( visitor instanceof BaliLanguageVisitor ) {
        return visitor.visitEmptyCollection(this);
    } else {
        return visitor.visitChildren(this);
    }
};
...
function NewlineCollectionContext(parser, ctx) {
	CollectionContext.call(this, parser);
    CollectionContext.prototype.copyFrom.call(this, ctx);
    return this;
}

NewlineCollectionContext.prototype = Object.create(CollectionContext.prototype);
NewlineCollectionContext.prototype.constructor = NewlineCollectionContext;

BaliLanguageParser.NewlineCollectionContext = NewlineCollectionContext;

NewlineCollectionContext.prototype.NEWLINE = function(i) {
	if(i===undefined) {
		i = null;
	}
    if(i===null) {
...
NewlineCollectionContext.prototype.expression = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
...
NewlineCollectionContext.prototype.enterRule = function(listener) {
    if(listener instanceof BaliLanguageListener ) {
        listener.enterNewlineCollection(this);
	}
};

NewlineCollectionContext.prototype.exitRule = function(listener) {
    if(listener instanceof BaliLanguageListener ) {
        listener.exitNewlineCollection(this);
	}
};

NewlineCollectionContext.prototype.accept = function(visitor) {
    if ( visitor instanceof BaliLanguageVisitor ) {
        return visitor.visitNewlineCollection(this);
    } else {
        return visitor.visitChildren(this);
    }
};
...
BaliLanguageParser.prototype.collection = function() {
    ...
    try {
        ...
        case BaliLanguageParser.IDENTIFIER:
            localctx = new InlineCollectionContext(this, localctx);
            this.enterOuterAlt(localctx, 1);
            this.state = 144;
            this.expression(0);
            this.state = 149;
            ...
            while(_la===BaliLanguageParser.T__3) {
                this.state = 145;
        ...
        case BaliLanguageParser.NEWLINE:
            localctx = new NewlineCollectionContext(this, localctx);
            this.enterOuterAlt(localctx, 2);
            this.state = 152;
        ...
        case BaliLanguageParser.T__6:
            localctx = new EmptyCollectionContext(this, localctx);
            this.enterOuterAlt(localctx, 3);
...
BaliLanguageParser.prototype.table = function() {
    ...
    try {
        ...
        case BaliLanguageParser.NEWLINE:
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            while(_la===BaliLanguageParser.T__5 || ((((_la - 49)) & ~0x1f) == 0 && ((1 << (_la - 49)) & ((1 << (BaliLanguageParser.T__48 - 49)) | (1 << (BaliLanguageParser.T__65 - 49)) | (1 << (BaliLanguageParser.T__66 - 49)) | (1 << (BaliLanguageParser.T__67 - 49)) | (1 << (BaliLanguageParser.T__68 - 49)) | (1 << (BaliLanguageParser.T__70 - 49)) | (1 << (BaliLanguageParser.T__71 - 49)) | (1 << (BaliLanguageParser.T__72 - 49)) | (1 << (BaliLanguageParser.T__73 - 49)) | (1 << (BaliLanguageParser.T__74 - 49)) | (1 << (BaliLanguageParser.T__75 - 49)))) !== 0) || ((((_la - 81)) & ~0x1f) == 0 && ((1 << (_la - 81)) & ((1 << (BaliLanguageParser.TAG - 81)) | (1 << (BaliLanguageParser.SYMBOL - 81)) | (1 << (BaliLanguageParser.FRACTION - 81)) | (1 << (BaliLanguageParser.FLOAT - 81)) | (1 << (BaliLanguageParser.TIME - 81)) | (1 << (BaliLanguageParser.RESOURCE - 81)) | (1 << (BaliLanguageParser.VERSION - 81)) | (1 << (BaliLanguageParser.BINARY - 81)) | (1 << (BaliLanguageParser.TEXT_BLOCK - 81)) | (1 << (BaliLanguageParser.TEXT - 81)))) !== 0)) {
                this.state = 173;
                this.association();
                this.state = 174;
                this.match(BaliLanguageParser.NEWLINE);
...
BaliLanguageParser.prototype.key = function() {
    ...
    try {
        ...
        this.state = 190;
        _la = this._input.LA(1);
        if(_la===BaliLanguageParser.T__5) {
            this.state = 189;
            this.parameters();
        }
...
BaliLanguageParser.prototype.parameters = function() {
    ...
    this.enterRule(localctx, 18, BaliLanguageParser.RULE_parameters);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 192;
...
BaliLanguageParser.prototype.script = function() {
    ...
    this.enterRule(localctx, 20, BaliLanguageParser.RULE_script);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 196;
...
ExceptionClauseContext.prototype.exception = function() {
...
function ExceptionContext(parser, parent, invokingState) {
	if(parent===undefined) {
	    parent = null;
	}
	if(invokingState===undefined || invokingState===null) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = BaliLanguageParser.RULE_exception;
    return this;
}

ExceptionContext.prototype = Object.create(antlr4.ParserRuleContext.prototype);
ExceptionContext.prototype.constructor = ExceptionContext;

ExceptionContext.prototype.expression = function() {
    return this.getTypedRuleContext(ExpressionContext,0);
};
...
BaliLanguageParser.ExceptionContext = ExceptionContext;

BaliLanguageParser.prototype.exception = function() {

    var localctx = new ExceptionContext(this, this._ctx, this.state);
    this.enterRule(localctx, 30, BaliLanguageParser.RULE_exception);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 241;
        this.expression(0);
...
BaliLanguageParser.prototype.target = function() {
    ...
    this.enterRule(localctx, 40, BaliLanguageParser.RULE_target);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 272;
        this.symbol();
...
BaliLanguageParser.prototype.queueMessage = function() {
    ...
    this.enterRule(localctx, 44, BaliLanguageParser.RULE_queueMessage);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 277;
...
BaliLanguageParser.prototype.recipient = function() {
    ...
    this.enterRule(localctx, 46, BaliLanguageParser.RULE_recipient);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 282;
        this.expression(0);
...
BaliLanguageParser.prototype.publishEvent = function() {
    ...
    this.enterRule(localctx, 48, BaliLanguageParser.RULE_publishEvent);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 284;
...
BaliLanguageParser.prototype.waitForEvent = function() {
    ...
    this.enterRule(localctx, 50, BaliLanguageParser.RULE_waitForEvent);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 287;
...
BaliLanguageParser.prototype.event = function() {
    ...
    this.enterRule(localctx, 52, BaliLanguageParser.RULE_event);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 293;
        this.expression(0);
...
BaliLanguageParser.prototype.continueTo = function() {
    ...
    this.enterRule(localctx, 54, BaliLanguageParser.RULE_continueTo);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 295;
...
BaliLanguageParser.prototype.breakFrom = function() {
    ...
    this.enterRule(localctx, 56, BaliLanguageParser.RULE_breakFrom);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 300;
...
BaliLanguageParser.prototype.label = function() {
    ...
    this.enterRule(localctx, 58, BaliLanguageParser.RULE_label);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 305;
        this.name();
...
BaliLanguageParser.prototype.returnResult = function() {
    ...
    this.enterRule(localctx, 60, BaliLanguageParser.RULE_returnResult);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 307;
        ...
        this.state = 309;
        _la = this._input.LA(1);
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << BaliLanguageParser.T__0) | (1 << BaliLanguageParser.T__5) | (1 << BaliLanguageParser.T__7))) !== 0) || ((((_la - 45)) & ~0x1f) == 0 && ((1 << (_la - 45)) & ((1 << (BaliLanguageParser.T__44 - 45)) | (1 << (BaliLanguageParser.T__48 - 45)) | (1 << (BaliLanguageParser.T__49 - 45)) | (1 << (BaliLanguageParser.T__50 - 45)) | (1 << (BaliLanguageParser.T__53 - 45)) | (1 << (BaliLanguageParser.T__59 - 45)) | (1 << (BaliLanguageParser.T__65 - 45)) | (1 << (BaliLanguageParser.T__66 - 45)) | (1 << (BaliLanguageParser.T__67 - 45)) | (1 << (BaliLanguageParser.T__68 - 45)) | (1 << (BaliLanguageParser.T__70 - 45)) | (1 << (BaliLanguageParser.T__71 - 45)) | (1 << (BaliLanguageParser.T__72 - 45)) | (1 << (BaliLanguageParser.T__73 - 45)) | (1 << (BaliLanguageParser.T__74 - 45)) | (1 << (BaliLanguageParser.T__75 - 45)))) !== 0) || ((((_la - 81)) & ~0x1f) == 0 && ((1 << (_la - 81)) & ((1 << (BaliLanguageParser.TAG - 81)) | (1 << (BaliLanguageParser.SYMBOL - 81)) | (1 << (BaliLanguageParser.FRACTION - 81)) | (1 << (BaliLanguageParser.FLOAT - 81)) | (1 << (BaliLanguageParser.TIME - 81)) | (1 << (BaliLanguageParser.RESOURCE - 81)) | (1 << (BaliLanguageParser.VERSION - 81)) | (1 << (BaliLanguageParser.BINARY - 81)) | (1 << (BaliLanguageParser.TEXT_BLOCK - 81)) | (1 << (BaliLanguageParser.TEXT - 81)) | (1 << (BaliLanguageParser.IDENTIFIER - 81)))) !== 0)) {
            this.state = 308;
            this.result();
        }
...
BaliLanguageParser.prototype.result = function() {
    ...
    this.enterRule(localctx, 62, BaliLanguageParser.RULE_result);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 311;
        this.expression(0);
...
ThrowExceptionContext.prototype.exception = function() {
    return this.getTypedRuleContext(ExceptionContext,0);
};
...
BaliLanguageParser.prototype.throwException = function() {
    ...
    this.enterRule(localctx, 64, BaliLanguageParser.RULE_throwException);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 313;
...
FunxionContext.prototype.name = function() {
    return this.getTypedRuleContext(NameContext,0);
};
...
MessageContext.prototype.name = function() {
    return this.getTypedRuleContext(NameContext,0);
};
...
IndicesContext.prototype.structure = function() {
    return this.getTypedRuleContext(StructureContext,0);
};
...
BaliLanguageParser.prototype.number = function() {
    ...
    try {
        ...
        case 5:
            ...
            _la = this._input.LA(1);
            if(!(_la===BaliLanguageParser.T__3 || _la===BaliLanguageParser.T__76)) {
...
BaliLanguageParser.prototype.name = function() {
    ...
    this.enterRule(localctx, 120, BaliLanguageParser.RULE_name);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 507;

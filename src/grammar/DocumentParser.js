...
DocumentParser.RULE_range = 33;
DocumentParser.RULE_sequence = 34;
DocumentParser.RULE_collection = 35;
DocumentParser.RULE_parameters = 36;
DocumentParser.RULE_list = 37;
...
DocumentParser.prototype.range = function() {
    ...
    this.enterRule(localctx, 66, DocumentParser.RULE_range);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 392;
...
DocumentParser.prototype.sequence = function() {
    ...
    this.enterRule(localctx, 68, DocumentParser.RULE_sequence);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 398;
        this.match(DocumentParser.T__33);
...
DocumentParser.prototype.collection = function() {
    ...
    this.enterRule(localctx, 70, DocumentParser.RULE_collection);
    try {
        this.state = 404;
        this._errHandler.sync(this);
...
DocumentParser.prototype.parameters = function() {
    ...
    this.enterRule(localctx, 72, DocumentParser.RULE_parameters);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 406;
        this.match(DocumentParser.T__35);
...
DocumentParser.prototype.list = function() {
    ...
    this.enterRule(localctx, 74, DocumentParser.RULE_list);
    var _la = 0; // Token type
    try {
        this.state = 428;
        this._errHandler.sync(this);
...
DocumentParser.prototype.catalog = function() {
    ...
    this.enterRule(localctx, 76, DocumentParser.RULE_catalog);
    var _la = 0; // Token type
    try {
        this.state = 448;
        this._errHandler.sync(this);
...
DocumentParser.prototype.association = function() {
    ...
    this.enterRule(localctx, 78, DocumentParser.RULE_association);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 450;
        this.element();
...
DocumentParser.prototype.procedure = function() {
    ...
    this.enterRule(localctx, 80, DocumentParser.RULE_procedure);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 454;
        this.match(DocumentParser.T__3);
...
DocumentParser.prototype.element = function() {
    ...
    this.enterRule(localctx, 84, DocumentParser.RULE_element);
    try {
        this.state = 492;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
DocumentParser.prototype.angle = function() {
    ...
    this.enterRule(localctx, 86, DocumentParser.RULE_angle);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 494;
...
DocumentParser.prototype.binary = function() {
    ...
    this.enterRule(localctx, 88, DocumentParser.RULE_binary);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 496;
...
DocumentParser.prototype.duration = function() {
    ...
    this.enterRule(localctx, 90, DocumentParser.RULE_duration);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 498;
...
DocumentParser.prototype.pattern = function() {
    ...
    this.enterRule(localctx, 98, DocumentParser.RULE_pattern);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 522;

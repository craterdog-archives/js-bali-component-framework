...
DocumentParser.RULE_duration = 48;
DocumentParser.RULE_moment = 49;
DocumentParser.RULE_name = 50;
DocumentParser.RULE_number = 51;
...
DocumentParser.RULE_version = 59;
...
DocumentParser.prototype.duration = function() {
    ...
    this.enterRule(localctx, 96, DocumentParser.RULE_duration);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 506;
...
DocumentParser.prototype.moment = function() {
    ...
    this.enterRule(localctx, 98, DocumentParser.RULE_moment);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 508;
...
DocumentParser.prototype.name = function() {
    ...
    this.enterRule(localctx, 100, DocumentParser.RULE_name);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 510;
...
DocumentParser.prototype.number = function() {
    ...
    this.enterRule(localctx, 102, DocumentParser.RULE_number);
    try {
        this.state = 528;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
DocumentParser.prototype.pattern = function() {
    ...
    this.enterRule(localctx, 104, DocumentParser.RULE_pattern);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 530;
...
DocumentParser.prototype.percentage = function() {
    ...
    this.enterRule(localctx, 106, DocumentParser.RULE_percentage);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 532;
...
DocumentParser.prototype.probability = function() {
    ...
    this.enterRule(localctx, 108, DocumentParser.RULE_probability);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 534;
...
DocumentParser.prototype.symbol = function() {
    ...
    this.enterRule(localctx, 112, DocumentParser.RULE_symbol);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 538;
...
DocumentParser.prototype.tag = function() {
    ...
    this.enterRule(localctx, 114, DocumentParser.RULE_tag);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 540;
...
DocumentParser.prototype.text = function() {
    ...
    this.enterRule(localctx, 116, DocumentParser.RULE_text);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 542;
...
DocumentParser.prototype.version = function() {
    ...
    this.enterRule(localctx, 118, DocumentParser.RULE_version);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 544;

...
var ruleNames =  [ "document", "component", "value", "structure", "parameters", 
                   ...
                   "angle", "binary", "duration", "pattern", "imaginary", 
                   "moment", "name", "number", "percent", "probability", 
                   "real", "reference", "reserved", "symbol", "tag", "text", 
                   "version" ];
...
DocumentParser.RULE_pattern = 43;
...
DocumentParser.RULE_real = 50;
DocumentParser.RULE_reference = 51;
DocumentParser.RULE_reserved = 52;
...
DocumentParser.prototype.pattern = function() {
    ...
    this.enterRule(localctx, 86, DocumentParser.RULE_pattern);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 455;
...
DocumentParser.prototype.real = function() {
    ...
    this.enterRule(localctx, 100, DocumentParser.RULE_real);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 485;
...
DocumentParser.prototype.reserved = function() {
    ...
    this.enterRule(localctx, 104, DocumentParser.RULE_reserved);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 489;

...
DocumentParser.prototype.list = function() {
    ...
    try {
        ...
        case DocumentParser.EOL:
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            while(_la===DocumentParser.T__3 || ((((_la - 37)) & ~0x1f) == 0 && ((1 << (_la - 37)) & ((1 << (DocumentParser.T__36 - 37)) | (1 << (DocumentParser.T__38 - 37)) | (1 << (DocumentParser.T__46 - 37)) | (1 << (DocumentParser.T__64 - 37)) | (1 << (DocumentParser.T__65 - 37)) | (1 << (DocumentParser.T__66 - 37)) | (1 << (DocumentParser.T__67 - 37)))) !== 0) || ((((_la - 71)) & ~0x1f) == 0 && ((1 << (_la - 71)) & ((1 << (DocumentParser.T__70 - 71)) | (1 << (DocumentParser.T__71 - 71)) | (1 << (DocumentParser.T__72 - 71)) | (1 << (DocumentParser.T__73 - 71)) | (1 << (DocumentParser.T__74 - 71)) | (1 << (DocumentParser.T__75 - 71)) | (1 << (DocumentParser.T__78 - 71)) | (1 << (DocumentParser.T__79 - 71)) | (1 << (DocumentParser.ANGLE - 71)) | (1 << (DocumentParser.BINARY - 71)) | (1 << (DocumentParser.DURATION - 71)) | (1 << (DocumentParser.FRACTION - 71)) | (1 << (DocumentParser.PERCENTAGE - 71)) | (1 << (DocumentParser.IMAGINARY - 71)) | (1 << (DocumentParser.REAL - 71)) | (1 << (DocumentParser.MOMENT - 71)) | (1 << (DocumentParser.NAME - 71)) | (1 << (DocumentParser.RESOURCE - 71)) | (1 << (DocumentParser.REGEX - 71)) | (1 << (DocumentParser.SYMBOL - 71)) | (1 << (DocumentParser.TAG - 71)) | (1 << (DocumentParser.NARRATIVE - 71)) | (1 << (DocumentParser.QUOTE - 71)) | (1 << (DocumentParser.VERSION - 71)))) !== 0)) {
                this.state = 431;
                this.component();
                this.state = 432;
                this.match(DocumentParser.EOL);
...
DocumentParser.prototype.real = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if(_la===DocumentParser.T__46) {
            this.state = 521;
            this.match(DocumentParser.T__46);
        }

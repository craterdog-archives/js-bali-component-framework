...
var ruleNames =  [ "source", "document", "statement", "comment", "mainClause", 
                   ...
                   "number", "pattern", "percent", "probability", "reference", 
...
DocumentParser.RULE_checkoutClause = 8;
DocumentParser.RULE_saveClause = 9;
DocumentParser.RULE_discardClause = 10;
DocumentParser.RULE_commitClause = 11;
...
DocumentParser.RULE_percent = 53;
...
DocumentParser.prototype.checkoutClause = function() {
    ...
    this.enterRule(localctx, 16, DocumentParser.RULE_checkoutClause);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 182;
...
DocumentParser.prototype.saveClause = function() {
    ...
    this.enterRule(localctx, 18, DocumentParser.RULE_saveClause);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 193;
...
DocumentParser.prototype.discardClause = function() {
    ...
    this.enterRule(localctx, 20, DocumentParser.RULE_discardClause);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 199;
...
DocumentParser.prototype.commitClause = function() {
    ...
    this.enterRule(localctx, 22, DocumentParser.RULE_commitClause);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 202;
...
DocumentParser.prototype.percent = function() {
    ...
    this.enterRule(localctx, 106, DocumentParser.RULE_percent);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 532;

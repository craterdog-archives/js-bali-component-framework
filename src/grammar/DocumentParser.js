...
var ruleNames =  [ "document", "comment", "statement", "mainClause", "handleClause", 
...
DocumentParser.RULE_element = 43;
DocumentParser.RULE_angle = 44;
DocumentParser.RULE_binary = 45;
DocumentParser.RULE_duration = 46;
DocumentParser.RULE_moment = 47;
DocumentParser.RULE_name = 48;
DocumentParser.RULE_number = 49;
DocumentParser.RULE_pattern = 50;
DocumentParser.RULE_percent = 51;
DocumentParser.RULE_probability = 52;
...
DocumentParser.prototype.comment = function() {
    ...
    this.enterRule(localctx, 2, DocumentParser.RULE_comment);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 122;
...
DocumentParser.prototype.element = function() {
    ...
    this.enterRule(localctx, 86, DocumentParser.RULE_element);
    try {
        this.state = 490;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
DocumentParser.prototype.angle = function() {
    ...
    this.enterRule(localctx, 88, DocumentParser.RULE_angle);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 492;
...
DocumentParser.prototype.binary = function() {
    ...
    this.enterRule(localctx, 90, DocumentParser.RULE_binary);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 494;
...
DocumentParser.prototype.duration = function() {
    ...
    this.enterRule(localctx, 92, DocumentParser.RULE_duration);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 496;
...
DocumentParser.prototype.pattern = function() {
    ...
    this.enterRule(localctx, 100, DocumentParser.RULE_pattern);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 520;
...
DocumentParser.prototype.percent = function() {
    ...
    this.enterRule(localctx, 102, DocumentParser.RULE_percent);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 522;
...
DocumentParser.prototype.probability = function() {
    ...
    this.enterRule(localctx, 104, DocumentParser.RULE_probability);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 524;

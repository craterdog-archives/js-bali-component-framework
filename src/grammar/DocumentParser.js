...
var literalNames = [ null, "'handle'", "'matching'", "'with'", "'{'", "'}'", 
                     "':='", "'checkout'", "'at'", "'level'", "'from'", 
                     "'save'", "'to'", "'discard'", "'commit'", "'publish'", 
                     "'post'", "'wait'", "'for'", "'acknowledge'", "'if'", 
...
var ruleNames =  [ "document", "statement", "mainClause", "handleClause", 
                   ...
                   "waitClause", "acknowledgeClause", "ifClause", "selectClause", 
                   ...
                   "indices", "component", "value", "sequence", "collection", 
                   "parameters", "list", "catalog", "association", "procedure", 
                   "statements", "element", "angle", "binary", "duration", 
                   "moment", "name", "number", "pattern", "percent", "probability", 
                   "range", "reference", "symbol", "tag", "text", "version" ];
...
DocumentParser.RULE_acknowledgeClause = 13;
DocumentParser.RULE_ifClause = 14;
DocumentParser.RULE_selectClause = 15;
DocumentParser.RULE_withClause = 16;
DocumentParser.RULE_whileClause = 17;
DocumentParser.RULE_continueClause = 18;
DocumentParser.RULE_breakClause = 19;
DocumentParser.RULE_returnClause = 20;
DocumentParser.RULE_throwClause = 21;
DocumentParser.RULE_recipient = 22;
DocumentParser.RULE_subcomponent = 23;
DocumentParser.RULE_expression = 24;
DocumentParser.RULE_variable = 25;
DocumentParser.RULE_funcxion = 26;
DocumentParser.RULE_message = 27;
DocumentParser.RULE_arguments = 28;
DocumentParser.RULE_indices = 29;
DocumentParser.RULE_component = 30;
DocumentParser.RULE_value = 31;
DocumentParser.RULE_sequence = 32;
DocumentParser.RULE_collection = 33;
DocumentParser.RULE_parameters = 34;
DocumentParser.RULE_list = 35;
DocumentParser.RULE_catalog = 36;
DocumentParser.RULE_association = 37;
DocumentParser.RULE_procedure = 38;
DocumentParser.RULE_statements = 39;
DocumentParser.RULE_element = 40;
DocumentParser.RULE_angle = 41;
DocumentParser.RULE_binary = 42;
DocumentParser.RULE_duration = 43;
DocumentParser.RULE_moment = 44;
DocumentParser.RULE_name = 45;
DocumentParser.RULE_number = 46;
DocumentParser.RULE_pattern = 47;
DocumentParser.RULE_percent = 48;
DocumentParser.RULE_probability = 49;
DocumentParser.RULE_range = 50;
DocumentParser.RULE_reference = 51;
...
MainClauseContext.prototype.acknowledgeClause = function() {
    return this.getTypedRuleContext(AcknowledgeClauseContext,0);
};
...
function AcknowledgeClauseContext(parser, parent, invokingState) {
	if(parent===undefined) {
	    parent = null;
	}
	if(invokingState===undefined || invokingState===null) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = DocumentParser.RULE_acknowledgeClause;
    return this;
}

AcknowledgeClauseContext.prototype = Object.create(antlr4.ParserRuleContext.prototype);
AcknowledgeClauseContext.prototype.constructor = AcknowledgeClauseContext;

AcknowledgeClauseContext.prototype.expression = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
...
AcknowledgeClauseContext.prototype.enterRule = function(listener) {
    if(listener instanceof DocumentListener ) {
        listener.enterAcknowledgeClause(this);
	}
};

AcknowledgeClauseContext.prototype.exitRule = function(listener) {
    if(listener instanceof DocumentListener ) {
        listener.exitAcknowledgeClause(this);
	}
};

AcknowledgeClauseContext.prototype.accept = function(visitor) {
    if ( visitor instanceof DocumentVisitor ) {
        return visitor.visitAcknowledgeClause(this);
    } else {
        return visitor.visitChildren(this);
    }
};
...
DocumentParser.AcknowledgeClauseContext = AcknowledgeClauseContext;

DocumentParser.prototype.acknowledgeClause = function() {

    var localctx = new AcknowledgeClauseContext(this, this._ctx, this.state);
    this.enterRule(localctx, 26, DocumentParser.RULE_acknowledgeClause);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 209;
...
DocumentParser.prototype.ifClause = function() {
    ...
    this.enterRule(localctx, 28, DocumentParser.RULE_ifClause);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 214;
...
DocumentParser.prototype.selectClause = function() {
    ...
    this.enterRule(localctx, 30, DocumentParser.RULE_selectClause);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 233;
...
DocumentParser.prototype.withClause = function() {
    ...
    this.enterRule(localctx, 32, DocumentParser.RULE_withClause);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 248;
...
DocumentParser.prototype.whileClause = function() {
    ...
    this.enterRule(localctx, 34, DocumentParser.RULE_whileClause);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 259;
...
DocumentParser.prototype.continueClause = function() {
    ...
    this.enterRule(localctx, 36, DocumentParser.RULE_continueClause);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 264;
...
DocumentParser.prototype.breakClause = function() {
    ...
    this.enterRule(localctx, 38, DocumentParser.RULE_breakClause);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 267;
...
DocumentParser.prototype.returnClause = function() {
    ...
    this.enterRule(localctx, 40, DocumentParser.RULE_returnClause);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 270;
...
DocumentParser.prototype.throwClause = function() {
    ...
    this.enterRule(localctx, 42, DocumentParser.RULE_throwClause);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 274;
...
DocumentParser.prototype.recipient = function() {
    ...
    this.enterRule(localctx, 44, DocumentParser.RULE_recipient);
    try {
        this.state = 279;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
DocumentParser.prototype.subcomponent = function() {
    ...
    this.enterRule(localctx, 46, DocumentParser.RULE_subcomponent);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 281;
        this.variable();
...
DocumentParser.prototype.expression = function(_p) {
    ...
    var _startState = 48;
    this.enterRecursionRule(localctx, 48, DocumentParser.RULE_expression, _p);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 308;
...
DocumentParser.prototype.variable = function() {
    ...
    this.enterRule(localctx, 50, DocumentParser.RULE_variable);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 347;
...
DocumentParser.prototype.funcxion = function() {
    ...
    this.enterRule(localctx, 52, DocumentParser.RULE_funcxion);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 349;
        this.match(DocumentParser.IDENTIFIER);
...
DocumentParser.prototype.message = function() {
    ...
    this.enterRule(localctx, 54, DocumentParser.RULE_message);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 351;
        this.match(DocumentParser.IDENTIFIER);
...
DocumentParser.prototype.arguments = function() {
    ...
    this.enterRule(localctx, 56, DocumentParser.RULE_arguments);
    var _la = 0; // Token type
    try {
        this.state = 362;
        this._errHandler.sync(this);
...
DocumentParser.prototype.indices = function() {
    ...
    this.enterRule(localctx, 58, DocumentParser.RULE_indices);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 364;
...
DocumentParser.prototype.component = function() {
    ...
    this.enterRule(localctx, 60, DocumentParser.RULE_component);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 372;
        this.value();
...
DocumentParser.prototype.value = function() {
    ...
    this.enterRule(localctx, 62, DocumentParser.RULE_value);
    try {
        this.state = 379;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
DocumentParser.prototype.sequence = function() {
    ...
    this.enterRule(localctx, 64, DocumentParser.RULE_sequence);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 381;
        this.match(DocumentParser.T__32);
...
DocumentParser.prototype.collection = function() {
    ...
    this.enterRule(localctx, 66, DocumentParser.RULE_collection);
    try {
        this.state = 387;
        this._errHandler.sync(this);
...
DocumentParser.prototype.parameters = function() {
    ...
    this.enterRule(localctx, 68, DocumentParser.RULE_parameters);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 389;
        this.match(DocumentParser.T__34);
...
DocumentParser.prototype.list = function() {
    ...
    this.enterRule(localctx, 70, DocumentParser.RULE_list);
    var _la = 0; // Token type
    try {
        this.state = 411;
        this._errHandler.sync(this);
...
DocumentParser.prototype.catalog = function() {
    ...
    this.enterRule(localctx, 72, DocumentParser.RULE_catalog);
    var _la = 0; // Token type
    try {
        this.state = 431;
        this._errHandler.sync(this);
...
DocumentParser.prototype.association = function() {
    ...
    this.enterRule(localctx, 74, DocumentParser.RULE_association);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 433;
        this.element();
...
DocumentParser.prototype.procedure = function() {
    ...
    this.enterRule(localctx, 76, DocumentParser.RULE_procedure);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 437;
        this.match(DocumentParser.T__3);
...
DocumentParser.prototype.statements = function() {
    ...
    this.enterRule(localctx, 78, DocumentParser.RULE_statements);
    var _la = 0; // Token type
    try {
        this.state = 459;
        this._errHandler.sync(this);
...
DocumentParser.prototype.element = function() {
    ...
    this.enterRule(localctx, 80, DocumentParser.RULE_element);
    try {
        this.state = 476;
        this._errHandler.sync(this);
...
DocumentParser.prototype.angle = function() {
    ...
    this.enterRule(localctx, 82, DocumentParser.RULE_angle);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 478;
...
DocumentParser.prototype.binary = function() {
    ...
    this.enterRule(localctx, 84, DocumentParser.RULE_binary);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 480;
...
DocumentParser.prototype.duration = function() {
    ...
    this.enterRule(localctx, 86, DocumentParser.RULE_duration);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 482;
...
DocumentParser.prototype.name = function() {
    ...
    this.enterRule(localctx, 90, DocumentParser.RULE_name);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 486;
...
DocumentParser.prototype.pattern = function() {
    ...
    this.enterRule(localctx, 94, DocumentParser.RULE_pattern);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 506;
...
DocumentParser.prototype.percent = function() {
    ...
    this.enterRule(localctx, 96, DocumentParser.RULE_percent);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 508;
...
DocumentParser.prototype.probability = function() {
    ...
    this.enterRule(localctx, 98, DocumentParser.RULE_probability);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 510;
...
DocumentParser.prototype.range = function() {
    ...
    this.enterRule(localctx, 100, DocumentParser.RULE_range);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 513;
...
DocumentParser.prototype.reference = function() {
    ...
    this.enterRule(localctx, 102, DocumentParser.RULE_reference);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 519;

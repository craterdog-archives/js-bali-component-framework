...
var ruleNames =  [ "document", "literal", "parameters", "structure", "block", 
                   ...
                   "assignee", "component", "queueMessage", "recipient", 
                   "publishEvent", "waitForEvent", "event", "continueTo", 
                   "breakFrom", "label", "returnResult", "result", "throwException", 
                   "xception", "ifThen", "condition", "selectFrom", "selection", 
                   "option", "whileLoop", "withLoop", "sequence", "expression", 
                   "variable", "funxion", "message", "indices", "element", 
                   "any", "tag", "symbol", "moment", "reference", "version", 
                   "text", "binary", "probability", "percent", "real", "imaginary", 
                   "number" ];
